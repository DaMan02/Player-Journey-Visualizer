...
This dataset contains **5 days of production gameplay data** (Feb 10-14, 2026) from an extraction shooter. Each file records one player's journey through one match.
...
The game is an extraction shooter where:
